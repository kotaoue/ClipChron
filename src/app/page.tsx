...
type Tab = 'wish' | 'read' | 'hatena' | 'feedly';
  ...
  return (
    <>
      <div style={{ marginBottom: '0.5rem' }}>
        ...
        <button style={tabStyle(tab === 'feedly')} onClick={() => setTab('feedly')}>
          Feedly
        </button>
      </div>
      <input
      ...
      {tab === 'feedly' && (
        <BookmarkList apiPath="/api/bookmarks?source=feedly" searchQuery={searchQuery} />
      )}
    </>
  );
}
